...
//How would you test a black box program that took in a string and a character 
// and returned the number of occurrences of that character?  

import java.util.*;

class Hyland1{

    public static int computeSum( int i, int j ){
        return i + j;
    }
